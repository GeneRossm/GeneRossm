...
¡Bienvenido/a a mi perfil de GitHub! Soy estudiante del tercer año de bachillerato técnico vocacional en desarrollo de software del Instituto Nacional de San Miguel Tepezontes
...
- **Lenguajes & Frameworks:** Python (Flask), JavaScript (React)
- **Bases de Datos:** MariaDB / MySQL (Administración directa desde CLI)
- **Gestión de Contenido (CMS):** WordPress (WooCommerce, Elementor, optimización de servidores de producción)
